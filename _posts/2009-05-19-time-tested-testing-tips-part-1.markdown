...
<p>You need to <a href="/post/Treat-Your-Tests-Well/" target="_blank">treat your test code well</a>. It needs to follow a lot of the same rules as the rest of what you write.</p>
